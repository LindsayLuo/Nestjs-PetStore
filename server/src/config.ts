...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'NestjsPetStore';
  ...
  'jhipster.mail.from' = 'NestjsPetStore@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'NestjsPetStore API';
  'jhipster.swagger.description' = 'NestjsPetStore API documentation';
  ...
  'eureka.instance.appname' = 'NestjsPetStore';
  'eureka.instance.instanceId' = 'NestjsPetStore:${random.value}';
  ...
  'cloud.config.name' = 'NestjsPetStore';
